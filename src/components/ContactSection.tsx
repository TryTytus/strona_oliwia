      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <AnimatedSection className="text-center">
          <motion.h2
            ...
            className="mb-6 text-[#f5f1e8] border-b-4 border-[#f5f1e8] pb-4 inline-block font-serif text-4xl md:text-5xl italic"
          >
          ...
          <motion.p
            ...
            className="mb-12 text-[#d4cfc4] italic mt-8 text-lg"
          >
            Chcesz zamienić wspomnienia w ponadczasową sztukę? Skontaktuj się ze mną, aby omówić Twój wyjątkowy portret.
          </motion.p>
